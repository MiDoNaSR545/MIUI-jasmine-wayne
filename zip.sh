...
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Mi_A2_Stock_Splash_Screen_Dark.img/download
sudo mv -f download splash.img
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 3 ]]
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Mi_6X_Stcok_Splash_Screen_Light.img/download
sudo mv -f download splash.img
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 4 ]]
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Mi_6X_Stock_Splash_Screen.img/download
sudo mv -f download splash.img
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 5 ]]
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Mi_A2_Stock_Splash_Screen_Modified.img/download
sudo mv -f download splash.img
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 6 ]]
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Mi_A2_Stock_Splash_Screen_Dark_Modified.img/download
sudo mv -f download splash.img
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 7 ]]
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Mi_Android_One_Orange_Splash_Screen_Light.img/download
sudo mv -f download splash.img 
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 8 ]]
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Mi_Android_One_Orange_Splash_Screen_Dark.img/download
sudo mv -f download splash.img
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 9 ]]
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Team_Neon_Splash_Screen.img/download
sudo mv -f download splash.img 
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 10 ]]
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Custom_Xiaomi_Mi_A2_Android_One_Splash_Screen_Light.img/download
sudo mv -f download splash.img
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 11 ]]
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Custom_Xiaomi_Mi_A2_Android_One_Splash_Screen_Dark.img/download
sudo mv -f download splash.img
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 12 ]]
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Custom_Xiaomi_Mi_6X_Splash_Screen_Light.img/download
sudo mv -f download splash.img 
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 13 ]]
then
wget -q https://sourceforge.net/projects/teamneon-ports/files/Splash-Screens/IMG/Custom_Xiaomi_Mi_6X_Splash_Screen_Dark.img/download
sudo mv -f download splash.img
sed -i "27i package_extract_file(\"splash.img\", \"/dev/block/bootdevice/by-name/splash\");" META-INF/com/google/android/updater-script
elif [[ $SSTYLE == 14 ]]
then 
